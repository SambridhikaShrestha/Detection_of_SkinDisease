...
urlpatterns = [
    ...
    path('verify/<str:token>/', users_views.verify_email, name='verify_email'),

    path('verification-instructions/', users_views.VerificationInstructions, name='verification_instructions'),
